...
class LoginTic(object):
    ...
    def checkYanZheng(self, solution):
        ...
        dic = loads(str(cont.content, 'utf-8'))
    ...
    def loginTo(self):
        ...
        dic = loads(str(result.content, 'utf-8'))
    ...
    def getOrders(self):
        ...
        orderUrl =  'https://kyfw.12306.cn/otn/queryOrder/queryMyOrder'
        body = {
            'queryType': '1',
            'queryStartDate': '2016-09-23',
            'queryEndDate': '2017-09-23',
            'con_from_flag': 'my_order',
            'pageSize': '100000',
            'pageIndex': '0',
            'query_where': 'H'
        }
        result = self.session.post(url=orderUrl, data=body, headers=self.headers, verify=False)
        resultObj = loads(str(result.content, 'utf-8'))
